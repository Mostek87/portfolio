...
<body>
  ...
  <section id="about"  class="about-me-background" >
   ...
   <h2  class="header">Pokrótce o mnie</h2>
	  ...
	  <div class="interest-container">
	   <div class="interest-item poker">Poker</div>
	   <div class="interest-item diving">Nurkowanie</div>
	   <div class="interest-item space">Kosmos</div>
	   <div class="interest-item science">Nauka i technologia</div>
	  </div>
   </div>
 ...
 <section class="skills-background"  > 
   ...
   <section  class="projects-background" >
	  ...
	  <img src="img/rack.png" class="rack-decoration" />
		  ...
		  <ul class="projects-list">
		    <li class="project porn-empire">
			  <div class="pop-up-info">
			    <div class="project-description">Witryna z filmami dla osób dorosłych :)</div>
			   ...
			   <div class="pop-up-info">
			    <div class="project-description">Strona firmy zajmującej się kotłami grzewczymi</div>
				  <ul class="used-technologies-list" > 
				    ...
				    <div class="links-container">
					  <a class="created-website-link" href="http://www.nordteam-service.pl">Na żywo</a>
